...
export const NAV_ITEMS = [
    ...
    dropdown: [
      {
        links: [
          ...
          { title: "Business Visits", href: "/events#visits" },
        ],
      },
    ],
  },
  ...
  // HIDDEN AS PER REQUEST
  {
    ...
    dropdown: [
      {
        links: [
          { title: "Entrepreneurship Development", href: "/programs#entrepreneurship" },
          { title: "Capacity Building & Skill Training", href: "/programs#training" },
          { title: "Employability & Placement Support", href: "/programs#employability" },
          { title: "Internship Programmes", href: "/programs#internship" },
          { title: "Business Networking", href: "/programs#networking" },
          { title: "Corporate Partnerships", href: "/programs#corporate" },
          { title: "College Collaborations", href: "/programs#college" },
          { title: "Exhibitions", href: "/programs#exhibitions" },
        ],
      },
    ],
  },
  */
  {
    ...
    dropdown: [
      {
        links: [
          { title: "What is WENBA", href: "/wenba#about" },
          { title: "Register as Vendor", href: "/wenba#register" },
          { title: "Product Categories", href: "/wenba#categories" },
  ...
  },
  {
    ...
    dropdown: [
      {
        links: [
          { title: "Corporate Partnership", href: "/partner#corporate" },
          { title: "CSR Collaboration", href: "/partner#csr" },
          { title: "Educational Institutions", href: "/partner#education" },
          { title: "Volunteers", href: "/partner#volunteers" },
          { title: "Mentors", href: "/partner#mentors" },
          { title: "Sponsors", href: "/partner#sponsors" },
        ],
      },
    ],
  },
